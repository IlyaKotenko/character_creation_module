...
def attack(char_name: str, char_class: str) -> str:
    """Calculate and print attack points for a specific class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate and print defense points for a specific class."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не заблокиролвал урон')


def special(char_name: str, char_class: str) -> str:
    """Calculate and print special skill points for a specific class."""
    if char_class == 'warrior':
        return (f'{char_name}'
    ...
    return (f'{char_name} не применял специальных возможностей')
